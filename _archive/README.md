...
- `frameworks/encoded-founder/` — the workspace philosophy (3-layer encoding model, encoding flywheel)
...
If you are reading this because you want to go deep on why the workspace is structured the way it is — welcome. Start with `frameworks/encoded-founder/encoded-founder-thesis.md`.
