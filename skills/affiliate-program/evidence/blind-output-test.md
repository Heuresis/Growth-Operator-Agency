...
> Per `spec/BLIND-OUTPUT-TEST.md`. This skill produces an **Affiliate Program Specification**. Classification: **external** (published and read by real affiliate partners) — requires **2/3 evaluator pass**.
