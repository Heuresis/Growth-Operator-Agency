...
> Per `_archive/spec/BLIND-OUTPUT-TEST.md`. This skill produces an **Ad Creative Brief**. Classification: **external** — requires **2/3 evaluator pass** before live paid traffic. Ads are the public face of the offer — broken creative burns ad spend + pollutes the pixel.
...
- **2/3 Growth OS briefs** must have ≥ 1 evaluator say `creator` or `can't tell`
