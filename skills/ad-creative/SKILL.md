...
division: marketing
agent_affinity: [marketing-lead, paid-ads]
...
- `_archive/frameworks/cult-methodology/README.md` (authority positioning in ad hooks)
- `_archive/spec/INTEGRATIONS.md` (Meta Ads API + CAPI + Figma + Drive)
