...
1. **Read context:**
   ...
   - `Read` `reference/frameworks/primitives/specificity.md` (Seech), `reference/frameworks/instagram-profile-funnel/README.md` (Foss), Haynes + Slings operator files
...
- **Read** for loading SKILL.md, all upstream Docs, specificity/Foss references
...
- Scale via Haynes Creative Family Micro Tests — duplicate winner at 2× budget, never bid-increase
