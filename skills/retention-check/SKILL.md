...
- `reference/_archive/frameworks/classical/4-belief-layers.md` (belief-decay as churn driver)
...
- Frameworks:
  ...
  - `reference/_archive/frameworks/classical/4-belief-layers.md` (belief decay = churn driver)
