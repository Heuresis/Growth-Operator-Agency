...
> Per `reference/_archive/spec/BLIND-OUTPUT-TEST.md`. This skill produces a **Competitor Teardown + Whitespace Report**. Classification: **internal** — requires **1/3 evaluator pass**.
