...
- `_archive/frameworks/classical/market-hierarchy.md` — awareness-spectrum research × the VSL director 25-cell matrix
- `reference/frameworks/market-sophistication-overview.md` — the VSL director 4-stage application
- `_archive/frameworks/classical/schwartz-awareness-spectrum.md` — 5 awareness levels
...
- `_archive/frameworks/classical/pampa-market-sophistication.md`
...
- `_archive/spec/QUALITY.md` (triple-layer verification requirements)
