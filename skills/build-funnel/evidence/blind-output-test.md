...
> Per `reference/canonical/spec/BLIND-OUTPUT-TEST.md`. This skill produces a **Funnel Blueprint**. Classification: **external** — requires **2/3 evaluator pass** before paid traffic launches against the funnel.
