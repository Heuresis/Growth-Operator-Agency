...
- 1 generic-LLM launch plan (control — no Growth OS context, no upstream asset integration)
...
- **3 of 3 Growth OS plans** must have ≥ 1 evaluator say `creator` or `can't tell` (sacred tier — no slack)
- **No generic-LLM plan** should be identified as `creator`
- Average "Would you execute this?" ≥ 70% yes for Growth OS plans
