...
> Per `_archive/spec/BLIND-OUTPUT-TEST.md`. This skill produces a **Lead Magnet Brief** (one of 9 the acquisition economist types). Classification: **external** — requires **2/3 evaluator pass** before running paid traffic to the opt-in page.
