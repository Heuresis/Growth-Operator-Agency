---
description: Design a lead magnet in one of 9 types (Guide / Checklist / Cheat Sheet / Swipe File / Mini Course / Quiz / Calculator / Free Training / Custom). Hormozi $100M Leads. Opt-in target 30%+.
...
Per `handoffs/quality-revision.md`: auto-revise → surface gap → escalate to nurture-lead, log to `skills/lead-magnet/evidence/failure-modes.md`.
