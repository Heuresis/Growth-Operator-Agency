...
- **Read** `reference/sub-agents/market-research-icp/` for the raw Growth Optimal System methodology
- **Bash** for running any utility scripts (none required for v1)

## Quality gates

Before writing the brief to `output/`:
- Run through `reference/_archive/spec/QUALITY.md` triple-layer verification
