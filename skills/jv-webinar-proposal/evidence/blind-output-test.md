...
- **≥ 2 of 3 Growth OS proposals** must have ≥ 1 evaluator say `real-creator` or `can't tell`
- **No generic-LLM proposal** should be identified as `real-creator`
- Average "Would you respond?" ≥ 60% yes for Growth OS proposals
...
- **Critical:** Evaluator #1 (past JV partner) must NOT flag Growth OS proposals as template — their calibration is the hardest and most predictive
