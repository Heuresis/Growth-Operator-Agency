...
agent_affinity: [foundations-lead, offer-architect]
required_compartments:
  audience_intelligence_system: 70    # ICP Document complete
  offer_architecture: 20              # creator has basic offer concept
  creator_identity_matrix: 40
upstream_dependency: build-icp        # ICP Document required; /build-positioning recommended
...
3. **Name the mechanism.** "The Growth OS Method." "The Revenue Engineering Protocol." "The Clarity System." Not "my 8-week program." Named mechanisms make offers memorable + reference-able + ownable.
