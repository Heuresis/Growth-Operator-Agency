...
> Per `spec/BLIND-OUTPUT-TEST.md`. This skill produces an **Email Sequence** (one of 8 types). Classification: **external** — requires **2/3 evaluator pass** before sending to creator's production list.
