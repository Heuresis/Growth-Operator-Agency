...
- Signal-theory S/N composite score below threshold (< 0.5 internal, < 0.8 external per `spec/QUALITY.md`)
...
- `../spec/QUALITY.md` — verification spec
- `../spec/BLIND-OUTPUT-TEST.md` — the gold-standard validation protocol
