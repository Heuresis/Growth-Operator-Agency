...
S = (M, G, T, F, W). Each dimension scored 0.0-1.0. Composite S/N must exceed threshold per `_archive/spec/QUALITY.md`.
...
- `../_archive/spec/QUALITY.md` — triple-layer verification spec
