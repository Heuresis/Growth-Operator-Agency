...
Signal Theory is the quality substrate. Every output produced by this workspace is a Signal encoded as a 5-tuple `(Mode, Genre, Type, Format, Structure)`. The S/N quality gate, the Blind Output Test, and the triple-layer verification protocol all derive from Signal Theory. See `reference/canonical/spec/SIGNAL.md`.
...
- The agent architecture (the 82KB bible at `reference/canonical/AGENT-ARCHITECTURE.md`).
