# Value Equation - Hormozi Operator Version

> **Source:** Alex Hormozi, *$100M Offers* + *$100M Offers Implementation Guide* (21-day build)
> **Companion:** `reference/frameworks/primitives/value-equation.md` (operator-agnostic primitive)

This file is the Hormozi-specific encoding. The primitive file covers the equation as a general tool; this file covers how Hormozi *operates* on each variable, including the Implementation Guide's specific dial-settings.
...
Hormozi's Implementation Guide Step 3 forces one specific exercise: "Help [avatar] achieve [specific outcome] so they can [deeper benefit/status gain]." Two clauses. The first clause is the metric. The second clause is the identity shift.
...
## Hormozi-Specific Repositioning Protocol

When an offer underperforms, Hormozi's Guide says to diagnose which of the four variables is actually broken, not to add more bonuses. The Troubleshooting Guide is explicit:
...
- Alex Hormozi, *$100M Offers Implementation Guide* - Phase 2 Steps 3-5 (Dream Outcome, Problems List, Solutions), Phase 4 Steps 8-11 (Guarantee, Scarcity, Bonuses, Naming), Phase 5 Step 12 (Pricing).
...
---
*v1.0 - 2026-04-19. Hormozi-specific operator encoding of the Value Equation.*
