# the offer architect, Framework Index
...
These pre-existing files are concept-thematic rather than operator-indexed, but cover the offer architect material. They continue to live in `../esoteric-marketing/` and `../offer-architecture/` and are cross-referenced where relevant.
