...
From Chapter V, Visual 5 "Decisions vs. Processes" — applied across four functions. Every Growth Operating Agency /build-sop session runs this separation:
...
Operational sequence for a Growth Operating Agency encoding session:
...
## How This Layer Model Binds to Growth Operating Agency
...
- **The INVARIANTS doc** is itself Layer 1 — decision logic about what Growth Operating Agency is and is not, which carries forward regardless of which skills implement it.
